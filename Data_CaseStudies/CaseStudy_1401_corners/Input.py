...
## Session2
        ...
        session1.plot_base_dir = "/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings"
        session1.orange_file = "/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/data1.tab"
        groups.append(session1)
                
        files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_Empty_02", "Empty-2", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerBoard_02", "Corner02-2", session1))
        ##files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerComputer", "Corner01-1", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerComputer_02", "Corner01-2", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerDoor", "Corner03-1", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerDoor_02", "Corner03-2", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerWindow", "Corner04-1", session1))
        #files.append( Input_Data("/home/stephan/Daten/Arbeit/Lehre/Goettingen/Vorlesung_SelectedAspectsOfPervasiveComputing/CaseStudy3/Recordings/loggingLectureRoom_CornerWindow_02", "Corner04-2", session1))
